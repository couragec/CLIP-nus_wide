...
class ValDataset(Dataset):
    def __init__(self, args, image_names, transforms, predefined_path):
...
for idx in range(len(val_dataset_subset)):
    ...
    # 获取预定义的图像路径
    predefined_path = os.path.join(data_dir, "Flickr", "actor", "0001_2124494179.jpg")

    similarity_threshold = 0.5  # 设置相似性分数的阈值
    predicted_label = predict_image_labels(predefined_path, similarity_threshold)
